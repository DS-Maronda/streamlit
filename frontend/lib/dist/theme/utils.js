...
export const getMergedLightTheme = once(() => {
  var _window$__streamlit;
  return mergeTheme(lightTheme, (_window$__streamlit = window.__streamlit) === null || _window$__streamlit === void 0 ? void 0 : _window$__streamlit.LIGHT_THEME);
});
export const getMergedDarkTheme = once(() => {
  var _window$__streamlit2;
  return mergeTheme(darkTheme, (_window$__streamlit2 = window.__streamlit) === null || _window$__streamlit2 === void 0 ? void 0 : _window$__streamlit2.DARK_THEME);
});
...
const deleteOldCachedThemes = () => {
  ...
  for (let i = 1; i <= CACHED_THEME_VERSION; i++) {
    localStorage.removeItem("".concat(CACHED_THEME_BASE_KEY, "-v").concat(i));
  }
};
