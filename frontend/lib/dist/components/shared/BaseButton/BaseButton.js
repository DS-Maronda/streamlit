...
function BaseButton(_ref) {
  ...
  return /*#__PURE__*/_jsx(ComponentType, {
    kind: kind,
    size: size !== null && size !== void 0 ? size : BaseButtonSize.MEDIUM,
