  ...
  describe("FloatData", () => {
    ...
    describe("Formatting", () => {
      it("allows explicit formatting string", () => {
        ...
        expect(screen.getByTestId("stNumberInput")).toBeInTheDocument();
        expect(screen.getByTestId("stNumberInput-Input")).toHaveDisplayValue("1.1111");
      });
    });
    ...
    it("automatically sets formatting when none provided based on step", () => {
      ...
      expect(screen.getByTestId("stNumberInput")).toBeInTheDocument();
      expect(screen.getByTestId("stNumberInput-Input")).toHaveDisplayValue("1.000");
    });
    it("does not automatically format when a format is explicitly provided", () => {
      ...
      expect(screen.getByTestId("stNumberInput")).toBeInTheDocument();
      expect(screen.getByTestId("stNumberInput-Input")).toHaveDisplayValue("1.00");
    });
