...
const getProps = function () {
  ...
  return {
    element: ButtonGroupProto.create({
      id: "1",
      options: [ButtonGroupProto.Option.create({
        content: ":material/".concat(materialIconNames[0], ":")
      }), ButtonGroupProto.Option.create({
        content: ":material/".concat(materialIconNames[1], ":"),
        selectedContent: ":material/icon2_selected:"
      }), ButtonGroupProto.Option.create({
        content: ":material/".concat(materialIconNames[2], ":")
      }), ButtonGroupProto.Option.create({
        content: ":material/".concat(materialIconNames[3], ":")
      })],
...
describe("ButtonGroup widget", () => {
  ...
  describe("ButtonGroup props should work", () => {
    ...
    it("onClick prop for multi select", () => {
      ...
      fireEvent.click(buttons[1]);
      expect(props.widgetMgr.setIntArrayValue).toHaveBeenCalledWith(props.element, [2, 1], {
        fromUi: true
      }, undefined);
      fireEvent.click(getButtonGroupButtons()[0]);
