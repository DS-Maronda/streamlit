...
export class Quiver {
  ...
  get cssStyles() {
    var _this$_styler;
    return ((_this$_styler = this._styler) === null || _this$_styler === void 0 ? void 0 : _this$_styler.styles) || undefined;
  }

  /** The DataFrame's caption, if it's been set. */
  get caption() {
    var _this$_styler2;
    return ((_this$_styler2 = this._styler) === null || _this$_styler2 === void 0 ? void 0 : _this$_styler2.caption) || undefined;
  }
  ...
  getCell(rowIndex, columnIndex) {
    var _this$_styler4, _this$_styler5;
    const {
      headerRows,
      headerColumns,
      rows,
    ...
    if (isIndexCell) {
      ...
      const cssId = (_this$_styler3 = this._styler) !== null && _this$_styler3 !== void 0 && _this$_styler3.uuid ? "".concat(this.cssId, "level").concat(columnIndex, "_row").concat(dataRowIndex) : undefined;
    ...
    const dataRowIndex = rowIndex - headerRows;
    const dataColumnIndex = columnIndex - headerColumns;
    const cssId = (_this$_styler4 = this._styler) !== null && _this$_styler4 !== void 0 && _this$_styler4.uuid ? "".concat(this.cssId, "row").concat(dataRowIndex, "_col").concat(dataColumnIndex) : undefined;
    ...
    const displayContent = (_this$_styler5 = this._styler) !== null && _this$_styler5 !== void 0 && _this$_styler5.displayValues ? this._styler.displayValues.getCell(rowIndex, columnIndex).content : undefined;
    return {
